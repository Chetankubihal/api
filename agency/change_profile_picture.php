...
$agency->employeeEmail= $_POST['employeeEmail'] ;

//tokenize email to use it as image name
$image_name=strtok($agency->employeeEmail,'@');
...
$image_name=strtok($agency->employeeEmail,'@').".".$imageFileType;


if($agency->change_profile_picture($image_name))
{
    ...
    echo json_encode(array("message" => "failed outside"));// failed because of database or query error
